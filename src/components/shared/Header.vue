<template>
    <nav id="nav" class="sm:container sm:mx-auto border-b">
        <div
        ...
        >
            ...
            >
                ...
                >
                    <button
                        class="sm:hidden block text-left text-md font-medium bg-red-700 hover:bg-red-800 text-white shadow-sm rounded-md px-4 py-2 mt-2"
                        @click="showModal()"
            ...
            <div class="hidden sm:flex justify-between items-center flex-col md:flex-row">
                <div>
                    <button
                        class="text-md font-medium bg-red-700 hover:bg-red-800 text-white shadow-sm rounded-lg px-5 py-2.5"
                        @click="showModal()"
                        aria-label="Hire Me Button"
                    >
                        Hire Me
                                ...
                                >
                                    ...
                                    >
                                        <form class="max-w-xl m-4 text-left">
                                            ...
                                            <div class="mt-6">
                                                <button
                                                    class="px-6 py-2.5 text-white font-medium tracking-wider bg-red-700 hover:bg-red-800 rounded-lg focus:ring-1 focus:ring-indigo-900"
                                                    type="submit"
                                    ...
                                    >
                                        <button
                                            class="px-6 py-2 bg-red-500 hover:bg-red-600 rounded-lg font-bold text-primary-light focus:ring-1 focus:ring-indigo-900"
                                            @click="showModal()"
